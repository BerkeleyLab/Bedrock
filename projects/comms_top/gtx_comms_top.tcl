...
# proc add_gtx_protocol {config_file quad_num gtx_num en8b10b pll_type}
...
set en8b10b 0
set pll_type "CPLL"
add_gt_protocol $gt_type $GTX_CONFIG_DIR/gtx_ethernet.tcl $quad $gtx $en8b10b $pll_type

set quad 0
set gtx 1
set en8b10b 1
set pll_type "CPLL"
add_gt_protocol $gt_type $GTX_CONFIG_DIR/gtx_chitchat.tcl $quad $gtx $en8b10b $pll_type
