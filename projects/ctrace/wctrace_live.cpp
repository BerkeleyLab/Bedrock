// An almost exact copy of badger/tests/mem_gateway_wrap.cpp
#include <signal.h>
#include <verilated.h>

// Include model header, generated from Verilating "wctrace_top.v"
#include "Vwctrace_top.h"
...
int main(int argc, char** argv, char** env) {
	...
	Vwctrace_top* top = new Vwctrace_top;
	...
	if (flag && 0==strcmp(flag, "+trace")) {
		...
		tfp->open("wctrace_top.vcd");  // Open the dump file
	}
