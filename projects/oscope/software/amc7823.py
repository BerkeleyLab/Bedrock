...
#		])
#	#print 'after write',
#	prc.reg_read_value(["U15_sdo_addr, U15_spi_rdbk"])#,"U15_spi_ready,U15_sdio_as_sdo","U15_spi_start,U15_spi_read_r","U15_spi_data_r,U15_spi_addr_r"])
#	time.sleep(0.2)
...
#	print val.encode('hex')#,"U15_spi_ready,U15_sdio_as_sdo","U15_spi_start,U15_spi_read_r","U15_spi_data_r,U15_spi_addr_r"])
...
#	prc.amc_write(1,0xd,0xffff)
	...
	if 1:
		for addr in range(11):
			...
			print(([format(i,'04x') for i in adcs],'%6.3f'%((adcs[4]&0xfff)*2.5/2**12)))
		for addr in addrs:
