...
// Include model header, generated from Verilator
#include <verilated_vcd_c.h>
#include "Vbadger_lwip_tb.h"
...
int main(int argc, char** argv, char** env) {
	...
	Vbadger_lwip_tb* top = new Vbadger_lwip_tb;
	...
	if (flag && 0==strcmp(flag, "+trace")) {
		...
		tfp->open("badger_lwip.vcd");  // Open the dump file
	}
