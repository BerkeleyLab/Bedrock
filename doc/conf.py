...
latex_documents = [
    (master_doc, 'Bedrock.tex', 'Bedrock Documentation',
     'LBNL ATG', 'manual'),
]
...
man_pages = [
    (master_doc, 'bedrock', 'Bedrock Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Bedrock', 'Bedrock Documentation',
     author, 'Bedrock', 'One line description of project.',
     'Miscellaneous'),
]
