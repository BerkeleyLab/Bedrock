...
# go ahead and run it.
pwd
python3 litex_setup.py --init --update --tag 2025.08 --config standard && pip3 install --no-build-isolation git+https://github.com/litex-hub/pythondata-cpu-picorv32.git
