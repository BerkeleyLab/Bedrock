...
git clone https://github.com/litex-hub/pythondata-cpu-picorv32.git && cd pythondata-cpu-picorv32 && pip3 install --no-build-isolation --break-system-packages -e . && cd ..
