...
def verilog_rom(a, suffix=""):
    ...
    config_case = '\n'.join([
        '''\t%i'h%3.3x: dxx <= 16'h%4.4x;''' % (max_add_size+1, ix, a[ix])
        for ix in range(len(a))
    ])
    return '''// 16k x 16 ROM machine generated by python verilog_rom()
module config_romx''' + suffix + '''(
\tinput clk,
    ...
    if args.live:
        ...
        if args.loopback:
            ...
            with open(args.verilog_file, 'w') as f:
                f.write(verilog_rom(a, suffix=args.mod_suffix))
